...
namespace PHPNomad\Di\Container;
...
class Container implements InstanceProvider, HasBindings
{
    /**
     ...
     * @return static
     */
    public function bind(string $concrete, string $abstract, string ...$abstracts): static
    {
        $instance = null;
     ...
     * @return static
     */
    public function bindFactory(string $abstract, callable $factory): static
    {
